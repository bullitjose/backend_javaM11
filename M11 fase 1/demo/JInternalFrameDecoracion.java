...
public class JInternalFrameDecoracion extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JInternalFrameDecoracion frame = new JInternalFrameDecoracion();
...
private void FillData2() {
	 ...
	 * Create the frame.
	 */
	public JInternalFrameDecoracion() {
		setClosable(true);
