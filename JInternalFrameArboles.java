...
public class JInternalFrameArboles extends JInternalFrame {
	...
	public JInternalFrameArboles() {
		...
		//-----------------------------------------------------------------nuevo
		//Seleccionar boton borrar y eliminamos el elemento de la lista
		
		final JFrame frame = new JFrame(JInternalFrameArboles.class.getSimpleName());
		...
		deleteItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(frame, "Has seleccionado BORRAR el elemento");
			//TODO LLAMAR BORRAR ELEMENTO
				FillData2();
			}
		});
		popupMenu.add(deleteItem);
		tableArbol.setComponentPopupMenu(popupMenu);

		scrollPane_1.setViewportView(tableArbol);

		JPanel panel = new JPanel();
		panel.setBorder(
				new TitledBorder(null, "Informacion del articulo", TitledBorder.LEADING, TitledBorder.TOP, null, null));
